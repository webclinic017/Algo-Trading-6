            ...
            while True:
                ...
                if get_account()['openPositionCount'] == 0 and len(get_account()['orders']) == 0:
                    ...
                    for ins in self.instruments:
                        ...
                        #Long signals
                        bull_cross = prev_stoch <= prev_stoch_ma and cur_stoch >= cur_stoch_ma
                        ...
                        #Short signals
                        bear_cross = prev_stoch >= prev_stoch_ma and cur_stoch <= cur_stoch_ma
                        emas_in_order = ema8 < ema14 and ema14 < ema50
